...
function _main() {
    ...
    _pubcst_tools_install "infection" "https://github.com/infection/infection/releases/latest/download/infection.phar"
    _pubcst_php "${PUBCST_TOOLS_DIRECTORY}/infection" "$@"
